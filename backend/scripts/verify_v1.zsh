...
# 2.1) audit_dossier schema doğrula
python scripts/validate_audit_dossier.py /tmp/risk_v1.json R-501
python scripts/validate_evidence_pack.py /tmp/risk_v1.json R-401A

# frontend contracts export
python scripts/export_frontend_contracts.py /tmp/risk_v1.json
