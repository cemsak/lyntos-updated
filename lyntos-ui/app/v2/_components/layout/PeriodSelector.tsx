  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      >
        ...
        <span className="flex-1 text-left text-[14px] text-[#1a1f36]">
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute top-full right-0 mt-1 w-[240px] bg-white border border-[#e3e8ee] rounded-lg shadow-lg z-50 py-1">
          {periods.map(period => (
            <button
              key={period.id}
              onClick={() => {
